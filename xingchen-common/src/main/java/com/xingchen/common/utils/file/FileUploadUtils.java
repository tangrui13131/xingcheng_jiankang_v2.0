package com.xingchen.common.utils.file;
...
import com.xingchen.common.exception.file.FileNameLengthLimitExceededException;
import com.xingchen.common.exception.file.FileSizeLimitExceededException;
import com.xingchen.common.exception.file.InvalidExtensionException;
import com.xingchen.common.utils.DateUtils;
import com.xingchen.common.utils.StringUtils;
import com.xingchen.common.utils.uuid.IdUtils;
import com.xingchen.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = XingChenConfig.getProfile();
    ...
    {
        int dirLastIndex = XingChenConfig.getProfile().length() + 1;
